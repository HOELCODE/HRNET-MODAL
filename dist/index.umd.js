(function(d,b){typeof exports=="object"&&typeof module<"u"?b(exports,require("react")):typeof define=="function"&&define.amd?define(["exports","react"],b):(d=typeof globalThis<"u"?globalThis:d||self,b(d.HrnetModal={},d.React))})(this,function(d,b){"use strict";var T={exports:{}},E={};/**
 * @license React
 ...
 */var w;function q(){if(w)return E;w=1;var s=Symbol.for("react.transitional.element"),f=Symbol.for("react.fragment");function m(R,a,i){var v=null;if(i!==void 0&&(v=""+i),a.key!==void 0&&(v=""+a.key),"key"in a){i={};for(var _ in a)_!=="key"&&(i[_]=a[_])}else i=a;return a=i.ref,{$$typeof:s,type:R,key:v,ref:a!==void 0?a:null,props:i}}return E.Fragment=f,E.jsx=m,E.jsxs=m,E}var x={};/**
 * @license React
...
React keys must be passed directly to JSX without using spread:
  ...
  <%s key={someKey} {...props} />`,n,o,p,o),z[o+n]=!0)}if(o=null,t!==void 0&&(m(t),o=""+t),v(r)&&(m(r.key),o=""+r.key),"key"in r){t={};for(var O in r)O!=="key"&&(t[O]=r[O])}else t=r;return o&&_(t,typeof e=="function"?e.displayName||e.name||"Unknown":e),X(e,o,l,u,a(),t,j,S)}function C(e){typeof e=="object"&&e!==null&&e.$$typeof===Y&&e._store&&(e._store.validated=1)}var h=b,Y=Symbol.for("react.transitional.element"),H=Symbol.for("react.portal"),k=Symbol.for("react.fragment"),B=Symbol.for("react.strict_mode"),Z=Symbol.for("react.profiler"),Q=Symbol.for("react.consumer"),K=Symbol.for("react.context"),ee=Symbol.for("react.forward_ref"),re=Symbol.for("react.suspense"),te=Symbol.for("react.suspense_list"),ne=Symbol.for("react.memo"),M=Symbol.for("react.lazy"),oe=Symbol.for("react.activity"),ae=Symbol.for("react.client.reference"),g=h.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,F=Object.prototype.hasOwnProperty,se=Array.isArray,y=console.createTask?console.createTask:function(){return null};h={"react-stack-bottom-frame":function(e){return e()}};var I,D={},L=h["react-stack-bottom-frame"].bind(h,i)(),$=y(R(i)),z={};x.Fragment=k,x.jsx=function(e,r,t,n,u){var l=1e4>g.recentlyCreatedOwnerStacks++;return N(e,r,t,!1,n,u,l?Error("react-stack-top-frame"):L,l?y(R(e)):$)},x.jsxs=function(e,r,t,n,u){var l=1e4>g.recentlyCreatedOwnerStacks++;return N(e,r,t,!0,n,u,l?Error("react-stack-top-frame"):L,l?y(R(e)):$)}}()),x}var P;function U(){return P||(P=1,process.env.NODE_ENV==="production"?T.exports=q():T.exports=W()),T.exports}var c=U();const J=()=>{const s=document.querySelector(".modal"),f=document.querySelector(".modal-container");document.querySelector(".close").addEventListener("click",()=>{f.style.display="none",s.style.display="none",s.classList.remove("modal-showed")})},V=()=>c.jsxs(c.Fragment,{children:[c.jsx("div",{className:"modal-container",children:c.jsxs("div",{className:"modal",children:[c.jsx("div",{className:"cross-container",onClick:J,children:c.jsx("span",{className:"close",children:"×"})}),c.jsx("div",{className:"modal-content",children:c.jsx("h2",{children:"Employee Created!"})})]})}),c.jsx("style",{children:`
                ...
                `})]});d.Modal=V,Object.defineProperty(d,Symbol.toStringTag,{value:"Module"})});
